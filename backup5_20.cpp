...
bool getCenter(Mat target, Mat frame, Rect2d rect, Rect2d &newTargetBBox) {
	...
	Point2d wShift = Point2d(target.size().width / 4 * 3, 0);
	Point2d hShift = Point2d(0, target.size().height / 4 * 3);
...
bool getCenter1(Mat target, Mat frame, vector<Rect> &boundRect, Rect2d &newTargetBBox) {
	...
	Point2d wShift = Point2d(target.size().width / 3 * 2, 0);
	Point2d hShift = Point2d(0, target.size().height / 3 * 2);
